...
$(OBJS): | $(obj).host/tools/v8_gypfiles/libv8_libbase.a $(obj).host/tools/v8_gypfiles/v8_maybe_icu.stamp $(obj).host/tools/v8_gypfiles/v8_headers.stamp $(obj).host/tools/v8_gypfiles/v8_config_headers.stamp $(obj).host/tools/v8_gypfiles/cppgc_headers.stamp $(obj).host/tools/v8_gypfiles/v8_version.stamp $(obj).host/tools/icu/icui18n.stamp $(obj).host/tools/icu/libicutools.a $(obj).host/tools/icu/icu_implementation.stamp $(obj).host/tools/icu/icu_uconfig.stamp $(obj).host/tools/icu/icuuc.stamp
